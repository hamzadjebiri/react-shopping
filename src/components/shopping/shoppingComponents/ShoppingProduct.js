            ...
            <div className="product-blog col-lg-4">
                ...
                <div className="card" style={{width: 18 +"rem"}}>
                    ...
                    <div className="card-body">
                      ...
                      <ShoppingAlert header={<img className="card-img-top" src={product.photos} alt="Card cap" />} body={<Description description={product.description} MaxCharNumber={200}/>} footer={<AddToShoppingCart />}>
